    ...
    <section class="skill__details">
        <div class="container">
            <ul class=" skill__detals_main">
                <li class="html skill__details--container">
                    <span>
                        <h4>HTML/CSS</h4>
                        <span></span>
                    </span>
                </li>
                <li class="BootStrap skill__details--container">
                    <span>
                        <h4>BootStrap</h4>
                        <span></span>
                    </span>
                </li>
                <li class="JavaScript skill__details--container">
                    <span>
                        <h4>JavaScript</h4>
                        <span></span>
                    </span>
                ...
                <li class="React skill__details--container">
                    <span>
                        <h4>React</h4>
                        <span></span>
                    </span>
                </li>
                <li class="PHP skill__details--container">
                    <span>
                        <h4>PHP</h4>
                        <span></span>
                    </span>
                </li>
                <li class="photoshop skill__details--container">
                    <span>
                        <h4>Photoshop</h4>
                        <span></span>
                    </span>
                </li>
                <li class="XD skill__details--container">
                    <span>
                        <h4>XD</h4>
                        <span></span>
                    </span>
    ...
    <section class="services">
        <div class="container">
            ...
            <div class="service__main">
                <div class="service__main__inner">
                    <h2>Front-end Development</h2>
                    <p>A strong penchant for detail and an eye for design allow me to code pixel-perfect webpages that are easy on the eyes and responsive across all major platforms.</p>
                </div>
            ...
            <div class="contact">
                <div class="contact__main">
                    <h2>Follow me</h2>
                    <ul>
                        <li><a href="https://github.com/ShahzebMalik107" target="black"><i class="fab fa-github"></i></a></li>
                        <li><a href="https://codepen.io/shahzebmalik" target="black"> <i class="fab fa-codepen"></i> </a></li>
                        <li><a href="https://www.linkedin.com/in/shahzeb-malik-632533180/" traget="black"> <i class="fab fa-linkedin-in"></i> </a></li>
                    </ul>
                </div>
                <div class="contact__main">
                    <h2>Contact me</h2>
                    <ul>
                        <li><a href="tel:+923165977334"><i class="fas fa-phone-alt"></i> +92-316-5977334</a></li>
                        <li><a href="mailto:shahzebworks@gmail.com"><i class="fas fa-envelope"></i> shahzebworks@gmail.com</a></li>
                    </ul>
                </div>
            </div>
        </div>
